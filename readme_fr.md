# LMS_eedomus
Plugin pour utiliser une Squeezebox avec l'Eedomus (avec retour d'état). 
...
Avant la version 7.6, Logitech avait inclu la possibilité d'avoir les informations en cours dans un XML.  
...
Sinon le dossier XML est hébergé sur ma [Dropbox](https://www.dropbox.com/sh/poa4cxsxccehdqv/AADj9PSSSk2Rb9XAJk1YylAKa?dl=0)  
